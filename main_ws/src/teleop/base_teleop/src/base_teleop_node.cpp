...
: rclcpp::Node("teleop", options)
{
  ...
  publisher_command_velocity_ =
    this->create_publisher<geometry_msgs::msg::TwistStamped>(topic_cmd_vel_, telemetry_qos);
  publisher_stop_lock_ = this->create_publisher<std_msgs::msg::Bool>(topic_stop_lock_,
      telemetry_qos);
